...
// 대신, 필요한 경우에 한해서 public으로 공개된 메서드를 제공함으로써
...
//		System.out.println(p1.age); // 필드 값 읽기
		...
		User user = new User(98765, "kkk123", "qwer123");
//		System.out.println("UserNumber: " + user.getUserNo());
...
//		System.out.println("비밀번호: " + user.getPassWord());
		...
		user.setUserId("hhh123");
		user.setPassWord("zxcv123");
//		System.out.println("UserNumber: " + user.getUserNo());
//		System.out.println("아이디: " + user.getUserId());
//		System.out.println("비밀번호: " + user.getPassWord());
		user.printUser();
