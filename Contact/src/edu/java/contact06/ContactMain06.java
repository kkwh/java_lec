...
public class ContactMain06 {
 ...
 // ContactUpateFrame에서 연락처 업데이트를 
    ...
    private void initialize() {
        ...
        btnInsert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ContactCreateFrame.showContactCreateFrame(frame, ContactMain06.this); //ContactCreateFrame이 ContactMain06의 멤버들을 사용할 수 있게끔 함
	...
	private void updateContact() {
		...
		ContactUpdateFrame.showContactUpdateFrame(frame, row, this); // ContactMain06.this 와 가르치는 주소가 같음.
	}
